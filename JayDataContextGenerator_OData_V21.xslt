...
<xsl:for-each select="//edm:EntityType | //edm:ComplexType" xml:space="default">
  ...
  <xsl:text xml:space="preserve">  </xsl:text><xsl:value-of select="jay:GetEntityBaseClass()"  />.extend('<xsl:value-of select="../@Namespace"/>.<xsl:value-of select="@Name"/>', {
...
<xsl:for-each select="//edm:EntityContainer">
  <xsl:text xml:space="preserve">  </xsl:text><xsl:value-of select="jay:GetContextBaseClass()"  />.extend('<xsl:value-of select="concat(jay:GetContextNamesace(../@Namespace), '.', @Name)"/>', {
...
<xsl:if test="jay:GetAutoCreateContext()">
  <xsl:value-of select="jay:GetContextNamesace(../@Namespace)"/>.<xsl:value-of select="jay:GetContextInstanceName()" /> = new <xsl:value-of select="concat(jay:GetContextNamesace(../@Namespace), '.', @Name)" />( { name:'oData', oDataServiceHost: '<xsl:value-of select="jay:GetSerivceUri()" />' });
</xsl:if>
  ...
  <xsl:template match="@Relationship" mode="render-field">
    ...
    <xsl:choose>
      <xsl:when test="$m = '*'">
        <type>'<xsl:value-of select="jay:GetCollectionBaseClass()"/>'</type>
