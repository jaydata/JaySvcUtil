<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
                xmlns:edm="http://schemas.microsoft.com/ado/2009/08/edm" 
...
<xsl:for-each select="edm:EntityType | edm:ComplexType" xml:space="default">
  ...
  export interface <xsl:value-of select="@Name"/>Queryable extends $data.Queryable {
    filter(predicate:(it: <xsl:value-of select="@Name"/>) => bool): <xsl:value-of select="@Name"/>Queryable;
    filter(predicate:(it: <xsl:value-of select="@Name"/>) => bool, thisArg: any): <xsl:value-of select="@Name"/>Queryable;

    map(projection: (it: <xsl:value-of select="@Name"/>) => any): <xsl:value-of select="@Name"/>Queryable;
    ...
    forEach(handler: (it: <xsl:value-of select="@Name"/>) => void ): $data.IPromise;
    
    toArray(): $data.IPromise;
    toArray(handler: (result: <xsl:value-of select="@Name"/>[]) => void): $data.IPromise;
    toArray(handler: { success?: (result: <xsl:value-of select="@Name"/>[]) => void; error?: (result: any) => void; }): $data.IPromise;

    single(predicate: (it: <xsl:value-of select="@Name"/>, params?: any) => bool, params?: any, handler?: (result: <xsl:value-of select="@Name"/>) => void): $data.IPromise;
    single(predicate: (it: <xsl:value-of select="@Name"/>, params?: any) => bool, params?: any, handler?: { success?: (result: <xsl:value-of select="@Name"/>[]) => void; error?: (result: any) => void; }): $data.IPromise;

    take(amout: number): <xsl:value-of select="@Name"/>Queryable;
    skip(amout: number): <xsl:value-of select="@Name"/>Queryable;

    order(selector: string): <xsl:value-of select="@Name"/>Queryable;
    orderBy(predicate: (it: <xsl:value-of select="@Name"/>) => any): <xsl:value-of select="@Name"/>Queryable;
    orderByDescending(predicate: (it: <xsl:value-of select="@Name"/>) => any): <xsl:value-of select="@Name"/>Queryable;
    
    first(predicate: (it: <xsl:value-of select="@Name"/>, params?: any) => bool, params?: any, handler?: (result: <xsl:value-of select="@Name"/>) => void): $data.IPromise;
    first(predicate: (it: <xsl:value-of select="@Name"/>, params?: any) => bool, params?: any, handler?: { success?: (result: <xsl:value-of select="@Name"/>[]) => void; error?: (result: any) => void; }): $data.IPromise;
    
    include(selector: string): <xsl:value-of select="@Name"/>Queryable;
...
<xsl:if test="local-name() != 'ComplexType'">
  export interface <xsl:value-of select="@Name"/>Set extends <xsl:value-of select="@Name"/>Queryable {
    add(initData: { <xsl:call-template name="generateProperties"><xsl:with-param name="properties" select="$ctorprops" /></xsl:call-template>}): <xsl:value-of select="@Name"/>;
    add(item: <xsl:value-of select="@Name"/>): <xsl:value-of select="@Name"/>;

    attach(item: <xsl:value-of select="@Name"/>): void;
    ...
    attachOrGet(item: <xsl:value-of select="@Name"/>): <xsl:value-of select="@Name"/>;
    attachOrGet(item: { <xsl:call-template name="generateProperties"><xsl:with-param name="properties" select="$keyprops" /></xsl:call-template>}): <xsl:value-of select="@Name"/>;

    detach(item: <xsl:value-of select="@Name"/>): void;
    ...
    remove(item: <xsl:value-of select="@Name"/>): void;
    ...
    elementType: new () => <xsl:value-of select="@Name"/>;
  }
